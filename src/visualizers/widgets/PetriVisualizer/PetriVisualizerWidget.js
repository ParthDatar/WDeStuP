...
define(['css!./styles/PetriVisualizerWidget.css'], function () {
    'use strict';
    ...
    PetriVisualizerWidget.prototype.addNode = function (desc) {
        if (desc) {
    ...
    PetriVisualizerWidget.prototype.removeNode = function (gmeId) {
        var desc = this.nodes[gmeId];
        this._el.append('<div>Removing node "' + desc.name + '"</div>');
        delete this.nodes[gmeId];
    };

    PetriVisualizerWidget.prototype.updateNode = function (desc) {
        if (desc) {
    ...
    PetriVisualizerWidget.prototype.onNodeClick = function (/*id*/) {
        // This currently changes the active node to the given id and
        // this is overridden in the controller.
    };

    PetriVisualizerWidget.prototype.onBackgroundDblClick = function () {
