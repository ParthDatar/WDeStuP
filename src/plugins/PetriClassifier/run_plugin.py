"""
This script is called by the plugin-wrapper, PetriClassifier.js, which passes down the
...
from PetriClassifier import PetriClassifier
...
plugin = PetriClassifier(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
