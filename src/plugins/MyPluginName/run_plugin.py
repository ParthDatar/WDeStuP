"""
This script is called by the plugin-wrapper, MyPluginName.js, which passes down the
...
from MyPluginName import MyPluginName
...
plugin = MyPluginName(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
